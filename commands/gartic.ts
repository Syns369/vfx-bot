...
module.exports = {
    ...
    category: 'Testing',
    description: 'Create a private gartic phone room for you and your friends', // Required for slash commands
    ...
    callback: async ({interaction} : {interaction : any}) => {
        ...
        await browser.defaultBrowserContext().overridePermissions('https://garticphone.com/fr', ['clipboard-read', 'clipboard-write']);

        const page = await browser.newPage(); //new page
        
        await page.goto("https://garticphone.com/fr"); //navigate to curvyton website
        await new Promise(r => setTimeout(r, 500));
        
        await page.click("#cmpbntyestxt"); //click on the agree button
        await new Promise(r => setTimeout(r, 500));
        
        await page.type(".jsx-46098086", "VFX-BOT"); //set profile name
        await new Promise(r => setTimeout(r, 500));
        
        await page.click(".jsx-4289504161"); //click on the next button
        await new Promise(r => setTimeout(r, 1000));
        
        await page.click(".jsx-4289504161");
        await new Promise(r => setTimeout(r, 1000));

        await page.bringToFront();
        //wait page navigation and screenshot
        // await page.waitForNavigation();
        await page.screenshot({path: 'gartic.png'});
